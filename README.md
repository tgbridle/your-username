...
- Modern AI app architectures (incl. retrieval and context techniques)

- Working with embeddings and vector stores

- Model Context Protocol (MCP) for tool-enabled agents

- Effective prompting and conversational design

- Low/no-code AI development (Lovable, Bubble, n8n, etc.)
